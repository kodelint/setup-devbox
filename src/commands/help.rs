...
fn show_edit_help(detailed: bool) {
...
fn add_edit_detailed_info(output: &mut String) {
...
///
/// * `output` - A mutable reference to the `String` where the content will be appended.
fn add_edit_behavior_info(output: &mut String) {
...
///
/// * `output` - A mutable reference to the `String` where the content will be appended.
fn add_edit_basic_examples(output: &mut String) {
